...
def build_spectral_ae(spect_shape):
    ...
    x = layers.Conv2DTranspose(f4, (1,1), padding='valid', strides=(1,1))(input_z)
    x = layers.LeakyReLU(alpha=0.1)(x)
    x = layers.BatchNormalization()(x)
    x = layers.Conv2DTranspose(f3, (2,2), padding='valid', strides=(2,2))(x)
    x = layers.LeakyReLU(alpha=0.1)(x)
    x = layers.BatchNormalization()(x)
    x = layers.Conv2DTranspose(f3, (2,2), padding='valid', strides=(2,2))(x)
    x = layers.LeakyReLU(alpha=0.1)(x)
    ...
    x = layers.LeakyReLU(alpha=0.1)(x)
    x = layers.BatchNormalization()(x)
    x = layers.Conv2DTranspose(f2, (2,2), padding='valid', strides=(2,2))(x)
    x = layers.LeakyReLU(alpha=0.1)(x)
    x = layers.BatchNormalization()(x)
    x = layers.Conv2DTranspose(f2, (2,2), padding='valid', strides=(2,2))(x)
    x = layers.LeakyReLU(alpha=0.1)(x)
